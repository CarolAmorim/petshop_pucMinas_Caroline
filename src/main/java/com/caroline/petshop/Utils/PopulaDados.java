...
public class PopulaDados {
	...
	public void cadastrar() {
		...
		Pet pet1 = new Pet(null,"John",esp1,raca1,6);
		Pet pet2 = new Pet(null,"Hana",esp1,raca2,5);
		Pet pet3 = new Pet(null,"Mewth",esp2,raca3,6);
		

		especieRepository.saveAll(Arrays.asList(esp1,esp1));
